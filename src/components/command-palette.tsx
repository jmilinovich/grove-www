...
export default function CommandPalette() {
  ...
  if (!open) {
    return (
      <button
        onClick={openPalette}
        className="fixed top-4 right-4 z-40 flex items-center gap-2 rounded-lg border border-surface-border bg-surface px-3 py-1.5 text-sm text-muted hover:text-foreground hover:border-muted transition-colors"
